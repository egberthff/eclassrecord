            ...
            <form method="POST" action="{{route('college.update' , $collection->id)}}" enctype="multipart/form-data" style="font-size: 12px;">
              ...
              <div class="form-group">
                <label class=" form-control-label">College <span style="color: red; font-weight: bold;">*</span></label>
                  <input type="text" id="company" value="{{$collection->name}}" placeholder="Enter College" class="form-control" name="name" aria-required="true" aria-invalid="false" data-validation="required">
              </div>

              <div class="form-group">
                  <label class=" form-control-label">Description <span style="color: red; font-weight: bold;">*</span></label>
                  <input type="text" id="description"  class="form-control"  name="description" aria-required="true" aria-invalid="false" data-validation="required" value="{{$collection->description}}">
              </div>

              <div class="form-group">
                  <label class=" form-control-label">Dean <span style="color: red; font-weight: bold;">*</span></label>
                  <input type="text" id="dean"  class="form-control"  name="dean" aria-required="true" aria-invalid="false" data-validation="required" value="{{$collection->dean}}">
              </div>
              <br>
              <div class="form-group">
