...
<div class="container">
                                    ...
                                    <tr class="tr-shadow" style="font-size: 12px; padding: 5px;">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                @if($element->status == 1)
                                                <a href="{{route('assignment.edit', $element->id)}}" style="margin-top: 10px;" class="item" data-toggle="tooltip"
                                                    data-placement="top" title="EDIT">
                                                    <i class="fs-5 bi bi-pencil-fill" style="color: blue;"></i>
                                                </a>
                                                <a href="{{route('assignment_add_score', $element->id)}}"
                                                ...
                                                <b style="color: green;">
                                                    <a href="{{route('assignment.destroy', $element->id)}}" style="margin-top: 10px;" class="item btnRem"
                                                ...
                                                @else
                                                <a href="{{route('assignment.destroy', $element->id)}}" style="margin-top: 10px;" class="item btnAct"
                                                    data-toggle="tooltip" data-placement="top"
    ...
    $(document).ready(function() {
        ...
        swal(
            'Activated',
            'Assignment has been removed from archive successfuly.',
            'success'
        )
        @elseif(Session::has('Archived'))
        swal(
            'Deleted',
            'Assignment has been added to archive.',
            'success'
        )
