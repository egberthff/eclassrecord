...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <form method="POST" action="{{route('major_exam.store')}}" enctype="multipart/form-data"
                                    ...
                                    <tr class="tr-shadow" style="font-size: 12px; padding: 5px;">
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                @if($element->status == 1)
                                                <a href="{{route('major_exam.edit', $element->id)}}" style="margin-top: 10px;" class="item" data-toggle="tooltip"
                                                    data-placement="top" title="EDIT">
                                                    <i class="fs-5 bi bi-pencil-fill" style="color: blue;"></i>
                                                </a>
                                                <a href="{{route('major_exam_add_score', $element->id)}}"
                                                ...
                                                <b style="color: green;">
                                                    <a href="{{route('major_exam.destroy', $element->id)}}"
    ...
    $(document).ready(function() {
        ...
        swal(
            'Activated',
            'Exam has been removed from archive successfuly.',
            'success'
        )
        @elseif(Session::has('Archived'))
        swal(
            'Deleted',
            'Exam has been added to archive.',
            'success'
        )
