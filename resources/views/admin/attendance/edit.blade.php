...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <form method="POST" action="{{route('attendance.update', $model->id)}}" enctype="multipart/form-data"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="company" class="form-control" name="name" aria-required="true"
                        aria-invalid="false" data-validation="required" value="{{$model->name}}" disabled>
                </div>
